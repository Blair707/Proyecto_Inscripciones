package com.educativa.bff.security;
...
/**
 * Convierte el claim personalizado de rol ("extension_Role") en un
 * GrantedAuthority tipo "ROLE_INSTRUCTOR" o "ROLE_ESTUDIANTE" para poder
 * usar @PreAuthorize. Mismo patrón que en examenes-service.
 */
@Component
